...
function messages(){
	function ses10(){
		...
		if(one){
			one.querySelector('.message1').innerHTML = '<a href="http://www.ses.com/4233325/news/2016/22407810" title="First booster to fly a second mission after successful landing" target="_blank">1st Reused Core!</a>';
